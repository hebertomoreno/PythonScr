...
def saveDrawing():
    ...
    # save the drawing as postscript image
    canvas.postscript(file = fileName + '.eps')
    # use the Pillow module to convert the postscript image into png
...
def main():
    ...
    # create parser
    descStr = """This program draws Spirographs using the Turtle
    module. When run witn no arguments, this program draws random
    Spirographs.
    ...
    required= False, help="The three arguments in sparams: R,r,l")
    # parse args
